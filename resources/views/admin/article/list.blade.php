								...
								@foreach ($article as $index=>$artcle) 
									<tr>
									  ...
									  <td>
								  	  ...
								  	  <td>
								  	  <input type="hidden" id="articleId_{{$artcle->id}}" value="{{$artcle->id}}"/>
									  	<A href="javascript:void(0);" title="Delete" id="deleteArticle" onclick="deleteArticle('{{$artcle->id}}')" > <i class="fa fa-times"></i></A>
										&nbsp;
								  	  </td>
									</tr>
								@endforeach	
